    ...
    <div class="col-md-6">
        <div style="height:46.5vh;overflow-y:scroll;overflow-x:hidden;" class="mt-2 mb-1 box box-dark">
            ...
            <div class="box-body">
                ...
                <h4>
                    Leucoctosis Frequecy
                </h4>
                
                <h4>
                    Thombocytosis Frequecy
                </h4>
                <h4>
                    Stool Occult Blood
                </h4>
                <h4>
                    Antistreptolysin O Position
                </h4>
                <h4>
                    Rheumatoid Factor
                </h4>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="p-2 mt-5 ml-1 mr-1">
                        <button type="button" onclick="submits()" class="btn btn-block btn-success btn-lg">Save &
                            Next</button>
                        <br>
                        @if ($inpatient=="YES")
                        ...
                        @if ($inpatient=="NO")
                        <button id="admit-btn" type="button" onclick="admitPatients('YES')"
                            class="btn btn-block btn-warning btn-lg">Admit Patient</button>
                        @endif

                        <br>
                        <button type="button" onclick="clearAlls()"
                            class="btn btn-block btn-danger btn-lg">Clears</button>
                    </div>
                </div>
            </div>
    ...
    function submits(){
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response==200){
                    clearAlls();
                    window.location.replace("{{route('check_patient_viewDental')}}");
                }
            },
            error: function(response){
                bootbox.alert({
