...
<body onload="startTime();setdate()" class="g-sidenav-show  bg-gray-100">
  ...
  <script>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y bg-white" id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
          <img src="./images/WKMHLogo.png" class="navbar-brand-img h-100" alt="main_logo">
          <span class="ms-1 font-weight-bold">WKM Hospital</span>
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse  w-auto h-100 " id="sidenav-collapse-main">
        <ul class="navbar-nav" data-widget="tree">
          ...
          <li class="nav-item {{Active::checkRoute('dash')}}">
          ...
          <li class="nav-item treeview {{Active::checkRoute(['patient','register_in_patient_view','searchPatient','searchData','discharge_inpatient','patientProfileIntro','patientProfile'])}}">
          ...
          <li class="nav-item {{Active::checkRoute('create_channel_view')}} ">
            <a class="nav-link  " href="{{route('create_channel_view')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item {{Active::checkRoute('searchTriage')}}">
            <a class="nav-link  " href="{{route('searchTriage')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <span class="nav-link-text ms-1">Triage</span>
            </a>
          </li>
          @endif

          @if($user_type=='Admin' || $user_type=='Lab')
          <li class="nav-item {{Active::checkRoute('searchLab')}}">
            <a class="nav-link  " href="{{route('searchLab')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item {{Active::checkRoute('check_patient_view')}}">
            <a class="nav-link  " href="{{route('check_patient_view')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item {{Active::checkRoute('check_patient_view')}}">
            <a class="nav-link  " href="{{route('check_patient_view')}}">
              ...
              <span class="nav-link-text ms-1">Check Patient</span>
            </a>
          </li>
          @endif
          ...
          {{--Issue Medicine--}}
          <li class="nav-item {{Active::checkRoute('issueMedicineView')}}">
            <a class="nav-link  " href="{{route('issueMedicineView')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item {{Active::checkRoute('medinventory')}}">
            <a class="nav-link  " href="{{route('medinventory')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Medicine Inventory</span>
            </a>
          </li>
          @endif
          
          @if ($user_type == "Theatre"  || $user_type=="Admin")
          <li class="nav-item {{Active::checkRoute('searchtheatre')}}">
            <a class="nav-link  " href="{{route('searchtheatre')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Theatre</span>
            </a>
          </li>
          @endif

          @if ($user_type == "Dialysis"  || $user_type=="Admin")
          <li class="nav-item {{Active::checkRoute('searchDialysis')}}">
            <a class="nav-link  " href="{{route('searchDialysis')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Dialysis</span>
            </a>
          </li>
          @endif

          @if ($user_type == "Radiology_imaging"  || $user_type=="Admin")
          <li class="nav-item {{Active::checkRoute('searchRadiology')}}">
            <a class="nav-link  " href="{{route('searchRadiology')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Radiology and Imaging</span>
            </a>
          </li>
          @endif

          @if ($user_type == "Cashier" || $user_type=="Admin")
          <li class="nav-item {{Active::checkRoute('cashiercheckp')}}">
            <a class="nav-link  " href="{{route('cashiercheckp')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>spaceship</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">WKMH</a></li>
          ...
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
              ...
              <li class="nav-item dropdown pe-2 d-flex align-items-center">
                <a href="javascript:;" class="nav-link text-body pb-3" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                  <i class="fa fa-user cursor-pointer"></i>
                </a>

                <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                  <!-- The user image in the profile/logout menu -->
                  <li class="user-header">
                      <img src="{{asset("$image_path")}}" class="img-circle" alt="User Image">
                      <p>{{$name}}</p>
                      <p><small>{{$user_type}}</small></p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
      ...
      <footer class="footer mt-3 pt-3 justify-content-center align-items-center">
