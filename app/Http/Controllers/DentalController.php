...
class DentalController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('dental.checkpatient_intro_dental', ['title' => "Check Patient"]);
    }
    ...
    public function checkPatient(Request $request)
    {
        ...
        //dd($triage->blood_pressure);

        return view('dental.checkpatient', [
            'title' => "Check Patient",
    ...
    {
        $user = Auth::user();
        $appointments = DB::table('appointments')->join('patients', 'appointments.patient_id', '=', 'patients.id')->select('patients.name', 'appointments.number', 'appointments.patient_id', 'appointments.completed')->whereRaw(DB::Raw('Date(appointments.created_at)=CURDATE()'))->orderBy('appointments.created_at', 'desc')->get();
